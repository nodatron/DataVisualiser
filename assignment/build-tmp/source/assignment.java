...
*/
public ArrayList<Float> readInReviewScores (String filename){
...
*/
public void drawReviewScoreBarChart (ArrayList<Float> data,
							  String[] dataNames
							  ) {
...
*/
public void drawBarChartAxis (ArrayList<Float> data, 
					   float border, 
					   float horRange, 
					   float verticalRange,
					   String[] dataNames
...
*/
public String[] readIntoStringArray (String filename) {
	String[] arr = loadStrings (filename);
...
*/
public void drawReviewScoreTrendGraph (ArrayList<Float> data) {
